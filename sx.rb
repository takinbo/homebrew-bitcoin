...
class Sx < Formula
  ...
  def install
    ...
    ENV.append 'CPPFLAGS', "-I#{boostgcc48.include}"  # append_to_cflags doesn't seem to work here
    ENV.append 'LDFLAGS', "-L#{boostgcc48.lib}"

    # I thought depends_on libbitcoin would be enough, but I guess not...
    leveldbgcc48 = Formula.factory('WyseNynja/bitcoin/leveldb-gcc48')
    ENV.append 'CPPFLAGS', "-I#{leveldbgcc48.include}"  # append_to_cflags doesn't seem to work here
    ENV.append 'LDFLAGS', "-L#{leveldbgcc48.lib}"

    # I thought depends_on obelisk would be enough, but I guess not...
    libconfiggcc48 = Formula.factory('WyseNynja/bitcoin/libconfig-gcc48')
    ENV.append 'CPPFLAGS', "-I#{libconfiggcc48.include}"  # append_to_cflags doesn't seem to work here
    ENV.append 'LDFLAGS', "-L#{libconfiggcc48.lib}"

    # I thought depends_on obelisk would be enough, but I guess not...
    zeromq2gcc48 = Formula.factory('WyseNynja/bitcoin/zeromq2-gcc48')
    ENV.append 'CPPFLAGS', "-I#{zeromq2gcc48.include}"  # append_to_cflags doesn't seem to work here
